...
class Vidu extends Component {
    ...
    micStatusChanged() {
        ...
        this.setState({ localUser: localUser });
        console.log("마이크 체인지 ===============", this.state.subscribers);
    }
                ...
                {this.state.session !== undefined ? (
                    <div id="session">
                        <div id="session-header">
                            ...
                            <button onClick={()=>this.camStatusChanged()}>카메라</button>
                            <button onClick={()=>this.micStatusChanged()}>마이크</button>
                            {this.state.subscribers.map((sub, i) => (
                                <div key={i} className="stream-container col-md-6 col-xs-6" onClick={() => this.handleMainVideoStream(sub)}>
                                    <UserVideoComponent
                                        streamManager={sub}
                                        user={localUser}
                                        mutedSound={localUser.isAudioActive()}
                                    />
                                </div>
                            ))}
                    </div>
